...
if(isset($_POST['submit'])){
  if ($_POST['recieverpin']!=0){
    $recieverpin=$_POST['recieverpin'];
    $_SESSION['recieverpin'] = $recieverpin;
...
<div class="row">
	<h2 style="text-align: center">Enter the PIN number of Reciever below:</h2>
</div>
...
<p align="center"><input  name='recieverpin' id="tbInput" class="PINtext" type="password" placeholder="Enter valid PIN" maxlength="4"/></p>
